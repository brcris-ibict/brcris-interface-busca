...
export const getServerSideProps: GetServerSideProps = async ({ locale }) => ({
  props: {
    ...(await serverSideTranslations(locale ?? 'en', ['common', 'navbar', 'advanced', 'facets', 'faq'])),
  },
});
      ...
      <header className="bg-light border-bottom">
        <div className="container py-3 d-flex flex-wrap align-items-center justify-content-between">
          ...
          <div className="d-flex flex-wrap gap-2">
            <button id="btnExpandAll" className="btn btn-outline-primary btn-sm">
              {t('Expand all')}
            </button>
            <button id="btnCollapseAll" className="btn btn-outline-secondary btn-sm">
              {t('Collapse all')}
            </button>
          </div>
        </div>
          ...
          <div className="accordion-item">
            <h3 className="accordion-header" id="q11-h">
              <button
                ...
                data-bs-target="#q11"
              >
                {t('My profile does not appear or is incomplete. What should I do?')}
              </button>
            </h3>
          ...
          <div className="accordion-item">
            <h3 className="accordion-header" id="q14-h">
              <button
                ...
                data-bs-target="#q14"
              >
                {t('I need support for a BrCris-related project. Is it possible?')}
              </button>
            </h3>
            <div id="q14" className="accordion-collapse collapse" aria-labelledby="q14-h">
              <div className="accordion-body">
                ...
                , {t('and the team will evaluate it according to BrCris objectives.')}
              </div>
            </div>
          </div>
        </div>
