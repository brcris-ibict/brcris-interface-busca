  ...
  return (
    <footer id="more" role="contentinfo">
      <div className="social-media-icons">
        <a href="https://www.youtube.com/user/IBICTbr/" target="_blank" rel="noreferrer" title="YouTube do IBICT">
        ...
        <a href="https://www.facebook.com/IBICTbr/" target="_blank" rel="noreferrer" title="Facebook do IBICT">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
        ...
        <a href="https://x.com/ibictbr" target="_blank" rel="noreferrer" title="X do IBICT">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
      ...
      <div className="footer">
        <a href="https://www.gov.br/mcti/pt-br" target="_blank" rel="noopener noreferrer">
          <picture>
            <img src="/logos/mcti-negativo.png" className="logo-rodape" alt="imagem com logo do ibict, minc e gov.br" />
          </picture>
        </a>
        ...
        <div className="copyright">
          ...
          <a rel="license" href="https://creativecommons.org/licenses/by-nd/3.0/deed.pt_BR">
